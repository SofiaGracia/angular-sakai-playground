...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, DataViewModule, FormsModule, SelectButtonModule, PickListModule, OrderListModule, TagModule, ButtonModule, RouterLink],
            ...
            <p-dataview [value]="products" [layout]="layout">
                ...
                <ng-template #list let-items>
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4" [ngClass]="{ 'border-t border-surface': i !== 0 }" [routerLink]="['/uikit/', item.name]">
